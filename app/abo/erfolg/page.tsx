...
export default function AboErfolgPage() {
  return (
    <main className="min-h-screen bg-[#0B0908] px-6 pb-36 text-[#F5E9D8]">
      <section className="flex min-h-screen items-center justify-center">
        <div className="w-full max-w-2xl rounded-[32px] border border-[#3A2B22] bg-[#171311] p-10 text-center shadow-2xl">
